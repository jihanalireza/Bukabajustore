    {{Form::open(['route'=>['positionUpdate','id'=>$dataPosition->id],'method'=>'put','enctype'=>'multipart/form-data'])}}
    <div class="row">   
        <div class="form-group col-md-6 @if($errors->has('codePosition')) has-primary @endif">
            <div class="col-sm-12">
                {{Form::label('Code Position')}}
                {{Form::text('codePosition',$dataPosition->kode_jabatan,['class'=>'form-control','placeholder'=>'Enter Code Position'])}}
        ...
        <div class="form-group col-md-6 @if($errors->has('namePosition')) has-primary @endif">
            <div class="col-sm-12">
                ...
                {{Form::text('namePosition',$dataPosition->nama_jabatan,['class'=>'form-control','placeholder'=>'Enter Code Position'])}}
